...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'sales_manager', 'sales_agent', 'viewer', name='userrole'), nullable=False),
    ...
    sa.Column('source', sa.Enum('website', 'referral', 'cold_call', 'social_media', 'email_campaign', 'trade_show', 'other', name='leadsource'), nullable=False),
